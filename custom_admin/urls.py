...
urlpatterns = [
    ...
    path('all-deposit/', views.AllDeposit.as_view(), name='admin-alldeposit'),
    path('active-deposit/', views.ActiveDeposit.as_view(), name='admin-activedeposit'),
    path('pending-deposit/', views.PendingDeposit.as_view(), name='admin-pendingdeposit'),
    ...
    path('all-withdraw/', views.AllWithdraw.as_view(), name='admin-allwithdraw'),
    path('completed-withdraw/', views.CompletedWithdraw.as_view(), name='admin-completedwithdraw'),
    path('pending-withdraw/', views.PendingWithdraw.as_view(), name='admin-pendingwithdraw'),
    ...
    path('all-transaction/', views.AllTransaction.as_view(), name='admin-alltransaction'),
    ...
    path('read-messages/', views.ReadMessages.as_view(), name='admin-readmessages'),
