...
#     plan_days = models.PositiveIntegerField(default=0,null=True,blank=True)
#     plan_end_date = models.DateTimeField(auto_now_add=True,null=True,blank=True)
#     plan_amount  = models.FloatField(default=0)
...
class Profile(models.Model):
    ...
    def calculate_live_profit_and_book_balance(self):
        ...
        if self.plan_name:
            ...
            self.available_balance = self.available_balance + self.bonus
            ...
            if time_difference > 0:
                ...
                self.book_balance = self.live_profit + self.available_balance + self.plan_amount + self.bonus
...
class InvestmentPlan (models.Model):
    plan_category = models.ForeignKey(InvestmentCategory, related_name='categories', on_delete=models.CASCADE, default=0)
    plan_name = models.CharField(max_length=50,null=True,blank=True)
...
class Site(models.Model):
    ...
    favicon = models.ImageField(upload_to='site_images', default='logo.png')
